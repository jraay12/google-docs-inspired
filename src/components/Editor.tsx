...
export default function Editor({ content, onChange, onImport }: Props) {
  ...
  return (
    <div className="flex flex-col flex-1">
      ...
      <div className="flex gap-1.5 mb-4 flex-wrap p-3 bg-[#faf8f5] border border-[#e0dbd3] border-b-0 items-center">
        ...
        {/* Import — pushed to the far right */}
      ...
      {/* Editor area */}
      <div
        className="flex-1 bg-white border border-[#e0dbd3] px-10 py-8 min-h-[480px] cursor-text focus-within:border-[#a07850] transition-colors duration-150"
